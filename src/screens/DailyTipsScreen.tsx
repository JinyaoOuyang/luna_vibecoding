...
import { DateSelector, Card } from '../components';
import { colors, spacing, borderRadius } from '../theme/colors';
import { mockDailyTips, generateWeekDays } from '../data/mockData';
...
export const DailyTipsScreen: React.FC<DailyTipsScreenProps> = ({ onNavigate }) => {
  ...
  const currentTip = mockDailyTips.find(tip => tip.date === '2024-03-20') || mockDailyTips[0];
